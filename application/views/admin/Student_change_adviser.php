...
<div>
	<center>
		<div>
			<form class="pure-form" method="post" action="con_change_adviser">
		...
		<div>
			...
			<tr>
				...
				<td witdth="40" align="left"><a href="<?php echo site_url('admin/change_adviser_details') ?>/<?php echo $u_key->student_number?>">Edit</a></td>
			</tr>
